...
public class AddStaffBottomSheetFragment extends BottomSheetDialogFragment {

    AddStaffBottomSheetInterface clickIntrfc = null;
    public AddStaffBottomSheetFragment(AddStaffBottomSheetInterface intrfc) {
        clickIntrfc = intrfc;
    }
